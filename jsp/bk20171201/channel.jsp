            ...
            <div class='page_content'>
                <div class='channel_qrcode_box'>
                    <span class='channel_qrcode_img'>
                        <img src="${pageContext.request.contextPath}/images/channel_qrcode_img.png" onerror='this.src="${pageContext.request.contextPath}/images/channel_qrcode_errorimg.png"'/>
                    </span>
                    <a>点击右上角分享</a>
                    <a>给微信或其他好友即可绑定</a>
                </div>
